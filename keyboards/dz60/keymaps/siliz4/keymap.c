...
enum { TAPD_CAPS_TG_NAV };

qk_tap_dance_action_t tap_dance_actions[] = {
    // Tap once for Caps Lock, twice to activate _NAV layer
    [TAPD_CAPS_TG_NAV] = ACTION_TAP_DANCE_LAYER_TOGGLE(KC_CAPS, _NAV),
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_DEFAULT] = LAYOUT(
        ...
        TD(TAPD_CAPS_TG_NAV), KC_A,     KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,          KC_ENT,
        KC_LSFT, XXXXXXX,  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, XXXXXXX,
        KC_LCTL, KC_LGUI, KC_LALT,                   KC_SPC,  KC_SPC,  KC_SPC,           KC_RALT, KC_RGUI, XXXXXXX, MO(3),   KC_RCTL
    ),
